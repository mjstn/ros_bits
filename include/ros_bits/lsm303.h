...
#define LSM_Acc_Sensitivity_2g_left_rotate     0  /*!< accelerometer sensitivity with 2 g full scale [mg/LSB] */
#define LSM_Acc_Sensitivity_4g_left_rotate     1  /*!< accelerometer sensitivity with 4 g full scale [mg/LSB] */
#define LSM_Acc_Sensitivity_8g_left_rotate     2 /*!< accelerometer sensitivity with 8 g full scale [mg/LSB] */


#define LSM_Acc_Lowpower_NormalMode             ((uint8_t)0x20)
#define LSM_Acc_Lowpower_05                     ((uint8_t)0x40)
#define LSM_Acc_Lowpower_1                      ((uint8_t)0x60)
#define LSM_Acc_Lowpower_2                      ((uint8_t)0x80)
#define LSM_Acc_Lowpower_5                      ((uint8_t)0xA0)
#define LSM_Acc_Lowpower_10                     ((uint8_t)0xC0)

// The following 4 were all out of wack.  Fixed per spec for an OR to ctrl reg1 A by mjsn Oct2014
#define LSM_Acc_ODR_50                          ((uint8_t)0x40)
#define LSM_Acc_ODR_100                         ((uint8_t)0x50)
#define LSM_Acc_ODR_400                         ((uint8_t)0x60)
#define LSM_Acc_ODR_1000                        ((uint8_t)0x70)

#define LSM_Acc_HiResDisable                    ((uint8_t)0x00)
#define LSM_Acc_HiResEnable                     ((uint8_t)0x08)

#define LSM_Acc_XEN                             ((uint8_t)0x01)
#define LSM_Acc_YEN                             ((uint8_t)0x02)
#define LSM_Acc_ZEN                             ((uint8_t)0x04)
#define LSM_Acc_XYZEN                           ((uint8_t)0x07)

#define LSM_Acc_FS_2                            ((uint8_t)0x00)
#define LSM_Acc_FS_4                            ((uint8_t)0x10)
#define LSM_Acc_FS_8                            ((uint8_t)0x20)
#define LSM_Acc_FS_16                           ((uint8_t)0x30)

#define LSM_Acc_Little_Endian                   ((uint8_t)0x00)
#define LSM_Acc_Big_Endian                      ((uint8_t)0x40)

#define LSM_Acc_BDU_Continuous                  ((uint8_t)0x00)
#define LSM_Acc_BDU_Single                      ((uint8_t)0x80)
...
*/
#define LSM_A_ADDRESS         0x32              // For AdaFruit Lsm303 board accelerometer
...
/*
 * To read more than one byte or 6 in the case of accel we have to set D7 true
 */
#define LSM_A_OUT_READ_ALL_ADDR     (0x80|LSM_A_OUT_X_L_ADDR)   
...
*/
#define LSM_M_ADDRESS         0x3C      // For AdaFruit Lsm303 board magnetometer
...
#define LSM_M_CRA_REG_ADDR     (uint8_t) 0x00
...
#define LSM_Magn_Sensitivity_XY_1_3Ga     (1000/1055)  /*!< magnetometer X Y axes sensitivity for 1.3 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_1_9Ga     (1000/795)   /*!< magnetometer X Y axes sensitivity for 1.9 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_2_5Ga     (1000/635)   /*!< magnetometer X Y axes sensitivity for 2.5 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_4Ga       (1000/430)   /*!< magnetometer X Y axes sensitivity for 4 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_4_7Ga     (1000/375)   /*!< magnetometer X Y axes sensitivity for 4.7 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_5_6Ga     (1000/320)   /*!< magnetometer X Y axes sensitivity for 5.6 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_XY_8_1Ga     (1000/230)   /*!< magnetometer X Y axes sensitivity for 8.1 Ga full scale [LSB/Ga] */

#define LSM_Magn_Sensitivity_Z_1_3Ga      (1000/950)  /*!< magnetometer Z axes sensitivity for 1.3 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_1_9Ga      (1000/710)  /*!< magnetometer Z axes sensitivity for 1.9 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_2_5Ga      (1000/570)  /*!< magnetometer Z axes sensitivity for 2.5 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_4Ga        (1000/385)  /*!< magnetometer Z axes sensitivity for 4 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_4_7Ga      (1000/335)  /*!< magnetometer Z axes sensitivity for 4.7 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_5_6Ga      (1000/285)  /*!< magnetometer Z axes sensitivity for 5.6 Ga full scale [LSB/Ga] */
#define LSM_Magn_Sensitivity_Z_8_1Ga      (1000/205)  /*!< magnetometer Z axes sensitivity for 8.1 Ga full scale [LSB/Ga] */
...
typedef struct
{
  uint8_t Power_Mode;  /*!<  Low power mode selection (see table 19 datasheet) */
  uint8_t ODR; /*!< Output Data Rate */
  uint8_t Axes_Enable;    /*!< Axes Enable */
  uint8_t FS;     /*!< Full Scale */
  uint8_t Data_Update;  /*!< Data Update mode : Continuos update or data don`t change until MSB and LSB nex reading */
  uint8_t Endianess;   /*!< Endianess */
  uint8_t HiResMode;   /*!< High Res mode */
...
typedef struct
{
  uint8_t HPF_Enable; /*!< HPF enable*/
  uint8_t HPF_Mode;  /*!<HPF MODE: Normal mode or Reference signal for filtering*/
  uint8_t HPF_Reference;     /*!< Reference value for filtering*/
  uint8_t HPF_Frequency;     /*!< HPF_frequency ft=ODR/6*HPc  HPc=8,16,32,64*/
...
typedef struct
{
  uint8_t M_ODR;     /*!< Magnetometer Output data Rate*/
  uint8_t Meas_Conf;    /*<Measurement Configuration: Normal, positive bias, or negative bias*/
  uint8_t Gain;        /*!<Gain Configuration*/
  uint8_t Mode;  /*!<Mode Conf: Continuos - Single*/
}LSM_Magn_ConfigTypeDef;

void LSM303_Acc_Config(LSM_Acc_ConfigTypeDef *LSM_Acc_Config_Struct);
void LSM303_Acc_Filter_Config(LSM_Acc_Filter_ConfigTypeDef *LSM_Acc_Filter_Config_Struct);
